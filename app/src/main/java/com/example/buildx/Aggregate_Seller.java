...
public class Aggregate_Seller extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aggregate_seller);
        ...
        Query query = collectionReference.orderBy("aggregate");
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                if(task.isSuccessful()){
                    for(QueryDocumentSnapshot document : task.getResult()){
                        String bricks = document.getString("aggregate");
