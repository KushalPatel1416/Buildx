...
public class Steel_Sellers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_steel_sellers);
        ...
        Query query = collectionReference.orderBy("steel");
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                if(task.isSuccessful()){
                    for(QueryDocumentSnapshot document : task.getResult()){
                        String bricks = document.getString("steel");
