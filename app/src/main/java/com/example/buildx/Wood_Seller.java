...
public class Wood_Seller extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wood_seller);
        ...
        Query query = collectionReference.orderBy("wood");
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                if(task.isSuccessful()){
                    for(QueryDocumentSnapshot document : task.getResult()){
                        String bricks = document.getString("wood");
