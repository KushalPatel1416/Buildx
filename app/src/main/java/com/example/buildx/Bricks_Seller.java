...
public class Bricks_Seller extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bricks_seller);
        ...
        Query query = collectionReference.orderBy("bricks");
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                if(task.isSuccessful()){
                    for(QueryDocumentSnapshot document : task.getResult()){
                        String bricks = document.getString("bricks");
//
